...
public abstract class DictionaryDrawer<TK, TV> : PropertyDrawer
{
    ...
    private static T DoField<T>(Rect rect, Type type, T value)
    {
        ...
        if (type == typeof(DInt)) return (T)(object)DIntDrawer.OnGUI(rect, (DInt)(object)value, GUIContent.none);
        
        if (type == typeof(DLong)) return (T)(object)DLongDrawer.OnGUI(rect, (DLong)(object)value, GUIContent.none);
        
        if (type == typeof(DFloat)) return (T)(object)DFloatDrawer.OnGUI(rect, (DFloat)(object)value, GUIContent.none);
