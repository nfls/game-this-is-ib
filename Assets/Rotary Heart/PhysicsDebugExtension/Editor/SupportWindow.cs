...
namespace RotaryHeart.Lib.PhysicsExtension
{
    public class SupportWindow : EditorWindow
    {
        ...
        [MenuItem("Tools/Physics Debug/About")]
        public static void ShowWindow()
        {
            ...
            myWindow.assetName = myWindow.IconContent("<size=20><b><color=#AAAAAA> Physics Debug Extension</color></b></size>", "", "");
        ...
        void OnGUI()
        {
            ...
            switch (ToolBarIndex)
            {
                case 0:
                    ...
                    if (GUILayout.Button("Support Forum"))
                        Application.OpenURL("https://forum.unity.com/threads/released-physics-debug-extension.481701/");
            ...
            if (GUILayout.Button(review, ReviewBanner, GUILayout.Height(30)))
                Application.OpenURL("https://www.assetstore.unity3d.com/en/#!/account/downloads/search=%20Physics%20Debug%20Extension");
        }
